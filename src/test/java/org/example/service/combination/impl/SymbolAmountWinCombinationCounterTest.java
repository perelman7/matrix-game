...
class SymbolAmountWinCombinationCounterTest {
    WinCombinationCounter combinationCounter = new SymbolAmountWinCombinationCounter();
    ...
    void countCondition() {
        ...
        Assertions.assertEquals(combinations.size(), 2);
        Assertions.assertEquals(combinations.get("A").get(0), "same_symbol_3_times");
        Assertions.assertEquals(combinations.get("C").get(0), "same_symbol_4_times");
